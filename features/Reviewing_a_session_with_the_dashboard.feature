Feature: Reviewing a kata with the dashboard
  ...
  Scenario: The number of tests run by an individual in a kata can be seen in the
            dashboard from a different browser instance
    ...
    Then the dashboard traffic lights for the only participant are "red,green"
