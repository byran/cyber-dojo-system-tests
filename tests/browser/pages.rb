...
module CyberDojo
  ...
  class Pages
    ...
    def initialize(driver, browser, wait, test)
      ...
      @main_assertions = PageAssertions.new(browser, @main, test)
      ...
      @individual_show_assertions = PageAssertions.new(browser, @individual_show, test)
      ...
      @group_show_assertions = PageAssertions.new(browser, @group_show, test)
      ...
      @setup_default_start_point_show_assertions = PageAssertions.new(browser, @setup_default_start_point_show, test)
      ...
      @kata_individual_assertions = PageAssertions.new(browser, @kata_individual, test)
      ...
      @kata_group_assertions = PageAssertions.new(browser, @kata_group, test)
      ...
      @id_join_show_assertions = PageAssertions.new(browser, @id_join_show, test)
      ...
      @id_rejoin_show_assertions = PageAssertions.new(browser, @id_rejoin_show, test)
      ...
      @id_review_show_assertions = PageAssertions.new(browser, @id_review_show, test)
      ...
      @kata_edit_assertions = PageAssertions.new(browser, @kata_edit, test)
      ...
      @dashboard_show_assertions = PageAssertions.new(browser, @dashboard_show, test)
